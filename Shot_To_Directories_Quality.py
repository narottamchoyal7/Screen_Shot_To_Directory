...
screenshot_shortcut = keyboard.Key.print_screen
region_shortcut = keyboard.Key.f9
save_exit_shortcut = keyboard.Key.f10
...
class ScreenshotApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Screenshot Tool Created By Narottam Pratha Choyal")
